...
class LineChartType2 extends StatelessWidget {
  const LineChartType2({required this.isShowingMainData, super.key});
        ...
        children: <Widget>[
                    ...
                    if (pickedDate != null) {
                      setState(() {
                        selectedDateRange = DateTimeRange(
                          start: pickedDate,
                          end: pickedDate.add(const Duration(days: 6)),
                        );
                      });
                    }
                  },
          ...
          Expanded(
            child: Padding(
              ...
              child: LineChartType2(isShowingMainData: isShowingMainData),
            ),
          ),
        ],
      ),
